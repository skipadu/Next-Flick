...
public class FavoriteMovieDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_FAVORITEMOVIE_TABLE = "CREATE TABLE " +
                ...
                FavoriteMovieContract.FavoriteMovieEntry.COLUMN_TITLE + TEXT_NOT_NULL +
                FavoriteMovieContract.FavoriteMovieEntry.COLUMN_MOVIE_ID + " INTEGER NOT NULL, " +
                FavoriteMovieContract.FavoriteMovieEntry.COLUMN_POSTER_PATH + TEXT_NOT_NULL +
                ...
                FavoriteMovieContract.FavoriteMovieEntry.COLUMN_SYNOPSIS + TEXT_NOT_NULL +
                FavoriteMovieContract.FavoriteMovieEntry.COLUMN_RELEASE_DATE + TEXT_NOT_NULL +
